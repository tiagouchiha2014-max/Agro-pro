...
const CACHE_NAME = 'agropro-v10.6';
const STATIC_CACHE = 'agropro-static-v10.6';
...
const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/assets/style.css?v=10.6',
  '/assets/supabase-client.js?v=10.6',
  '/assets/modules/core.js?v=10.6',
  '/assets/modules/shell.js?v=10.6',
  '/assets/modules/login.js?v=10.6',
  '/assets/modules/app-init.js?v=10.6',
  '/assets/modules/dashboard.js?v=10.6',
  '/assets/modules/propriedade.js?v=10.6',
  '/assets/modules/safras.js?v=10.6',
  '/assets/modules/centralgestao.js?v=10.6',
  '/assets/modules/fazendas.js?v=10.6',
  '/assets/modules/talhoes.js?v=10.6',
  '/assets/modules/insumos.js?v=10.6',
  '/assets/modules/produtos.js?v=10.6',
  '/assets/modules/estoque.js?v=10.6',
  '/assets/modules/insumosbase.js?v=10.6',
  '/assets/modules/aplicacoes.js?v=10.6',
  '/assets/modules/combustivel.js?v=10.6',
  '/assets/modules/clima.js?v=10.6',
  '/assets/modules/colheitas.js?v=10.6',
  '/assets/modules/manutencao.js?v=10.6',
  '/assets/modules/equipe.js?v=10.6',
  '/assets/modules/folhaSalarial.js?v=10.6',
  '/assets/modules/analiseSolo.js?v=10.6',
  '/assets/modules/maquinas.js?v=10.6',
  '/assets/modules/relatorios.js?v=10.6',
  '/assets/modules/configuracoes.js?v=10.6',
  '/assets/modules/ajuda.js?v=10.6',
  '/assets/modules/ia-helpers.js?v=10.6',
  '/assets/modules/defensivos.js?v=10.6',
  '/assets/modules/copilot.js?v=10.6',
  '/assets/modules/pagamento.js?v=10.6',
  '/assets/icon-192.png',
  '/assets/icon-512.png',
  '/manifest.json',
  '/favicon.ico',
