...
function pageClima(){
  ...
  function calcKPIs(rows){
    ...
    if(elHoje) elHoje.textContent = `${num(chuvaHoje||0,1)} mm`;
    if(el7) el7.textContent = `${num(chuva7d||0,1)} mm`;
    if(el30) el30.textContent = `${num(chuva30d||0,1)} mm`;
